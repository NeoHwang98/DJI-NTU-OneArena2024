...
picked_up = False
pickup_params = []
VM_List_picked_up = [] #the list of valid vision markers when loaded
VM_List_no_picked_up = [] #the list of valid vision markers when unloaded
distance = 2000 #set to a random large number
...
def seek():
    ...
    while True: #calibrate this
        ...
        '''
        elif direction==direction and set_condition:
            perform_action
